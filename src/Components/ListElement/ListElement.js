  ...
  const decreaseIcon = () => {
    return (
      <div
        ...
        onClick={ (e) => props.handleListElementUpdate(e, props.data.id, props.globalConst.DECREASE_PLAYER_SCORES) }>
  ...
  const increaseIcon = () => {
    return (
      <div
        ...
        onClick={ (e) => props.handleListElementUpdate(e, props.data.id, props.globalConst.INCREASE_PLAYER_SCORES) }>
  ...
  return(
    <li className="app-list__element">
      ...
      <div className="app-counter">
        { props.isAdmin ? decreaseIcon() : null }
        <div className="app-counter__data">{ props.data.score }</div>
        { props.isAdmin ? increaseIcon() : null }
      </div>

      { props.isAdmin ? deleteIcon() : null }
    </li>
  );
}
